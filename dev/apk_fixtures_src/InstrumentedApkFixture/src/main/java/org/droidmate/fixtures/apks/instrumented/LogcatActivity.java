...
public class LogcatActivity extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        Button button;
        button = (Button)findViewById(R.id.button_2_logback_msgs);
        button.setText(label_button_2_logcat_msgs);

        button = (Button)findViewById(R.id.button_3_other_msgs);
        button.setText(label_button_3_other_msgs);

        button = (Button)findViewById(R.id.button_junk_msgs);
